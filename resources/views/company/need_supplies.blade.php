...
<div class="container" style="margin-top:30px;" ng-cloak>
	...
	<div class="row">
		<form method="post"
			action="{{ url('company/' . $company->id . '/submit_order') }}"
			id="needSuppliesForm"
		>
			{{ csrf_field() }}
	...
	<div class="row" style="margin-top: 40px; margin-bottom:20px; ">
		...
		<div class="col-md-6" ng-show="( supplyItems | checkbBoxItemsKeyLength ) > 0">
			...
			<div class="form-group">
				...
				<input type="text" disabled class="form-control" id="user_login" value="{{ $company->address }}">
			</div>
			...
			<div class="printer_option alt_address_option form-group animate-show" ng-show="useAlternativeAddress">
				<div class="col-xs-12" style="margin-bottom:10px;">					
					...
					<input id="alt_address_address" type="text" class="form-control" ng-model="alternativeAddressAddr" />
				</div>
				<div class="col-xs-12" style="margin-bottom:10px;">					
					<label for="alt_address_attn" style="padding-left:0px;">
						Attention:
					</label>
					<input id="alt_address_attn" type="text" class="form-control" ng-model="alternativeAddressAttn" />
				</div>
			</div>
			<div class="form-group animate-show" ng-show="useAlternativeAddress">
				...
				<div class="col-xs-12 col-md-4" style="margin-bottom:10px;">					
					...
					<input id="alt_address_state" type="text" class="form-control" ng-model="alternativeAddressState" />
				</div>
				<div class="col-xs-12 col-md-4" style="margin-bottom:10px;">					
